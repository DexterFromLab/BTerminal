...
# Bash (not sh) because we use an array — dash lacks printf %q and
# the previous eval-based variant blew up on Mint/Ubuntu (#bterm-curl-hook).
filtered=()
for a in "\$@"; do
    case "\$a" in
